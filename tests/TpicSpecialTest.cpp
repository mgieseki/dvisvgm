...
TEST_F(TpicSpecialTest, stroke_polyline) {
	...
	handler.processSpecial("fp");
	EXPECT_EQ(recorder.getXMLSnippet(),
		"<polyline fill='none' points='0,0 72,72 72,0' stroke='#000' stroke-linecap='round' stroke-width='1'/>"
	);
	EXPECT_DOUBLE_EQ(handler.penwidth(), 1.0);
	EXPECT_LT(handler.grayLevel(), 0);
}
...
TEST_F(TpicSpecialTest, fill_dashed_polygon) {
	...
	EXPECT_EQ(recorder.getXMLSnippet(),
		"<polygon fill='#fff' points='0,0 72,72 72,0' stroke='#000' stroke-dasharray='144' stroke-width='1'/>"
	);
	EXPECT_DOUBLE_EQ(handler.penwidth(), 1.0);
	EXPECT_LT(handler.grayLevel(), 0);
}
...
TEST_F(TpicSpecialTest, fill_dotted_polygon) {
	...
	EXPECT_EQ(recorder.getXMLSnippet(),
		"<polygon fill='#fff' points='0,0 72,72 72,0' stroke='#000' stroke-dasharray='36 144' stroke-width='36'/>"
	);
	EXPECT_DOUBLE_EQ(handler.penwidth(), 1.0);
	EXPECT_LT(handler.grayLevel(), 0);
}
...
TEST_F(TpicSpecialTest, stroke_spline) {
	...
	EXPECT_EQ(recorder.getXMLSnippet(),
		"<polyline fill='none' points='0,0 72,72' stroke='#000' stroke-linecap='round' stroke-width='1'/>"
	);
	recorder.clear();
	handler.processSpecial("pa", "0 0");
	handler.processSpecial("pa", "1000 1000");
	...
	handler.processSpecial("sp");
	EXPECT_EQ(recorder.getXMLSnippet(),
		"<path d='M0 0L36 36Q72 72 90 54Q108 36 126 54T180 108Q216 144 144 90L72 36' fill='none' stroke='#000' stroke-width='1'/>"
	);
	EXPECT_DOUBLE_EQ(handler.penwidth(), 1.0);
	EXPECT_LT(handler.grayLevel(), 0);
}
...
TEST_F(TpicSpecialTest, stroke_dashed_spline) {
	...
	EXPECT_EQ(recorder.getXMLSnippet(),
		"<path d='M0 0L36 36Q72 72 90 54Q108 36 126 54T180 108Q216 144 108 72Z' fill='none' stroke='#000' stroke-dasharray='72' stroke-width='1'/>"
	);
	EXPECT_DOUBLE_EQ(handler.penwidth(), 1.0);
	EXPECT_LT(handler.grayLevel(), 0);
}
...
TEST_F(TpicSpecialTest, stroke_dotted_spline) {
	...
	handler.processSpecial("sp", "-1");
	EXPECT_EQ(recorder.getXMLSnippet(),
		"<path d='M0 0L36 36Q72 72 90 54Q108 36 126 54T180 108Q216 144 144 90L72 36' fill='none' stroke='#000' stroke-dasharray='1 72' stroke-width='1'/>"
	);
	EXPECT_DOUBLE_EQ(handler.penwidth(), 1.0);
	EXPECT_LT(handler.grayLevel(), 0);
}
...
TEST_F(TpicSpecialTest, stroke_ellipse) {
	...
	EXPECT_EQ(recorder.getXMLSnippet(),
		"<circle cx='0' cy='0' fill='none' r='36' stroke='#000' stroke-width='1'/>"
	);
	recorder.clear();
	handler.processSpecial("ar", "0 0 1000 500 0 7");
	EXPECT_EQ(recorder.getXMLSnippet(),
		"<ellipse cx='0' cy='0' fill='none' rx='72' ry='36' stroke='#000' stroke-width='1'/>"
	);
	recorder.clear();
	handler.processSpecial("pn", "100");
	handler.processSpecial("ar", "0 0 1000 500 -1 -8");
	EXPECT_EQ(recorder.getXMLSnippet(),
		"<ellipse cx='0' cy='0' fill='none' rx='72' ry='36' stroke='#000' stroke-width='7.2'/>"
	);
}
...
TEST_F(TpicSpecialTest, fill_ellipse) {
	...
	EXPECT_EQ(recorder.getXMLSnippet(),
		"<circle cx='0' cy='0' fill='#000' r='36'/>"
	);
	recorder.clear();
	handler.processSpecial("bk");
	handler.processSpecial("ia", "0 0 1000 500 0 7");
	EXPECT_EQ(recorder.getXMLSnippet(),
		"<ellipse cx='0' cy='0' fill='#000' rx='72' ry='36'/>"
	);
	recorder.clear();
	handler.processSpecial("pn", "100");
	handler.processSpecial("wh");
	...
	EXPECT_EQ(recorder.getXMLSnippet(),
		"<ellipse cx='0' cy='0' fill='#fff' rx='72' ry='36'/>"
	);
}
...
TEST_F(TpicSpecialTest, stroke_arc) {
	...
	EXPECT_EQ(recorder.getXMLSnippet(),
		"<path d='M72 0A72 36 0 0 1 50.91 25.46' fill='none' stroke='#000' stroke-linecap='round' stroke-width='1'/>"
	);
	recorder.clear();
	handler.processSpecial("ar", "0 0 1000 500 0 "+to_string(math::PI/2));
	EXPECT_EQ(recorder.getXMLSnippet(),
		"<path d='M72 0A72 36 0 0 1 0 36' fill='none' stroke='#000' stroke-linecap='round' stroke-width='1'/>"
	);
	recorder.clear();
	...
	EXPECT_EQ(recorder.getXMLSnippet(),
		"<path d='M72 0A72 36 0 1 1 -72 0' fill='none' stroke='#000' stroke-linecap='round' stroke-width='1'/>"
	);
	recorder.clear();
	handler.processSpecial("ar", "0 0 1000 500 0 "+to_string(5*math::PI/4));
	EXPECT_EQ(recorder.getXMLSnippet(),
		"<path d='M72 0A72 36 0 1 1 -50.91 -25.46' fill='none' stroke='#000' stroke-linecap='round' stroke-width='1'/>"
	);
	recorder.clear();
	handler.processSpecial("ar", "0 0 1000 500 0 "+to_string(3*math::PI/2));
	EXPECT_EQ(recorder.getXMLSnippet(),
		"<path d='M72 0A72 36 0 1 1 0 -36' fill='none' stroke='#000' stroke-linecap='round' stroke-width='1'/>"
	);
	recorder.clear();
	handler.processSpecial("ar", "0 0 1000 500 0 "+to_string(-3*math::PI/2));
	EXPECT_EQ(recorder.getXMLSnippet(),
