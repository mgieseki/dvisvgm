...
TEST(ShadingPatchTest, create) {
	...
	delete patch;
	patch = ShadingPatch::create(5, Color::RGB_SPACE);
	EXPECT_TRUE(dynamic_cast<LatticeTriangularPatch*>(patch));
	delete patch;
	patch = ShadingPatch::create(6, Color::RGB_SPACE);
	EXPECT_TRUE(dynamic_cast<CoonsPatch*>(patch));
	delete patch;
	patch = ShadingPatch::create(7, Color::RGB_SPACE);
...
TEST(ShadingPatchTest, colorQueryFuncs) {
	...
	TriangularPatch tp2(points, colors, Color::GRAY_SPACE, 0, 0);
	...
	TriangularPatch tp3(points, colors, Color::CMYK_SPACE, 0, 0);
	...
	TriangularPatch tp4(points, colors, Color::LAB_SPACE, 0, 0);
