...
"length 4 idiv{@rectcc}repeat}{@rectcc}ifelse clip :newpath}put @SD/rectfill{:g"
"save :newpath dup type/arraytype eq{aload length 4 idiv{@rectcc}repeat}{@rectc"
"c}ifelse fill :grestore}put @SD/rectstroke{gsave :newpath dup type/arraytype e"
...
"prcmd pop}def/@setpagedevice{pop<<>>/setpagedevice sysexec matrix setmatrix ne"
"wpath 0(setpagedevice)prcmd}def/@checknulldev{@GD/@nulldev get{currentpagedevi"
"ce maxlength 0 ne{@GD/@nulldev false put 0 1(setnulldevice)prcmd}if}if}def/prc"
"olor{currentcolorspace @setcolorspace currentrgbcolor 3(setrgbcolor)prcmd}def/"
"printgstate{@dodraw @GD/@nulldev get not and{matrix currentmatrix aload pop 6("
"setmatrix)prcmd applyscalevals currentlinewidth 1(setlinewidth)prcmd currentli"
"necap 1(setlinecap)prcmd currentlinejoin 1(setlinejoin)prcmd currentmiterlimit"
" 1(setmiterlimit)prcmd prcolor currentdash mark 3 1 roll exch aload length 1 a"
"dd -1 roll counttomark(setdash)prcmd pop}if}def/strconcat{exch dup length 2 in"
"dex length add string dup dup 4 2 roll copy length 4 -1 roll putinterval}def/s"
"etgstate{/setgstate sysexec printgstate}def/save{@UD begin/@saveID vmstatus po"
"p pop def end :save @saveID 1(save)prcmd}def/restore{:restore @checknulldev pr"
"intgstate @UD/@saveID known{@UD begin @saveID end}{0}ifelse 1(restore)prcmd}de"
"f/gsave 0 defpr/grestore{:grestore @checknulldev printgstate 0(grestore)prcmd}"
"def/grestoreall{:grestoreall @checknulldev setstate 0(grestoreall)prcmd}def/ro"
"tate{dup type/arraytype ne @dodraw and{dup 1(rotate)prcmd}if/rotate sysexec ap"
"plyscalevals}def/scale{dup type/arraytype ne @dodraw and{2 copy 2(scale)prcmd}"
"if/scale sysexec applyscalevals}def/translate{dup type/arraytype ne @dodraw an"
"d{2 copy 2(translate)prcmd}if/translate sysexec}def/setmatrix{dup/setmatrix sy"
"sexec @dodraw{aload pop 6(setmatrix)prcmd applyscalevals}{pop}ifelse}def/initm"
"atrix{matrix setmatrix}def/concat{matrix currentmatrix matrix concatmatrix set"
"matrix}def/makepattern{gsave<</mx 3 -1 roll>>begin<</XUID[1000000 @patcnt]>>co"
"py mx/makepattern sysexec dup begin PatternType 2 lt{PatternType @patcnt BBox "
"aload pop XStep YStep PaintType mx aload pop 15(makepattern)prcmd :newpath mat"
"rix setmatrix dup PaintProc 0 1(makepattern)prcmd @GD/@patcnt @patcnt 1 add pu"
"t}if end end grestore}def/setpattern{begin PatternType 1 eq{PaintType 1 eq{XUI"
"D aload pop exch pop 1}{:gsave[currentcolorspace aload length -1 roll pop]/set"
"colorspace sysexec/setcolor sysexec XUID aload pop exch pop currentrgbcolor :g"
"restore 4}ifelse(setpattern)prcmd currentcolorspace 0 get/Pattern ne{[/Pattern"
" currentcolorspace]/setcolorspace sysexec}if currentcolorspace @setcolorspace}"
"{/setpattern sysexec}ifelse end}def/setcolor{dup type/dicttype eq{setpattern}{"
"/setcolor sysexec/currentrgbcolor sysexec setrgbcolor}ifelse}def/setcolorspace"
"{dup/setcolorspace sysexec @setcolorspace}def/@setcolorspace{dup type/arraytyp"
"e eq{0 get}if/Pattern eq{1}{0}ifelse 1(setcolorspace)prcmd}def/setgray 1 defpr"
"/setcmykcolor 4 defpr/sethsbcolor 3 defpr/setrgbcolor 3 defpr/.setopacityalpha"
"{dup/.setopacityalpha sysexec 1(setopacityalpha)prcmd}def/.setshapealpha{dup/."
"setshapealpha sysexec 1(setshapealpha)prcmd}def/.setblendmode{dup/.setblendmod"
"e sysexec<</Normal 0/Compatible 0/Multiply 1/Screen 2/Overlay 3/SoftLight 4/Ha"
"rdLight 5/ColorDodge 6/ColorBurn 7/Darken 8/Lighten 9/Difference 10/Exclusion "
"11/Hue 12/Saturation 13/Color 14/Luminosity 15/CompatibleOverprint 16>>exch ge"
"t 1(setblendmode)prcmd}def/@pdfpagecount{(r)file runpdfbegin pdfpagecount runp"
"dfend}def/@pdfpagebox{(r)file runpdfbegin dup dup 1 lt exch pdfpagecount gt or"
"{pop}{pdfgetpage/MediaBox pget pop aload pop}ifelse runpdfend}def DELAYBIND{.b"
"indnow}if ";
