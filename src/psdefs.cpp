...
"exch}repeat :newpath moveto 50 50/scale sysexec true charpath fill :grestore/@"
...
"d}def/printgstate{@dodraw{matrix currentmatrix aload pop 6(setmatrix)prcmd app"
"lyscalevals currentlinewidth 1(setlinewidth)prcmd currentlinecap 1(setlinecap)"
"prcmd currentlinejoin 1(setlinejoin)prcmd currentmiterlimit 1(setmiterlimit)pr"
"cmd currentrgbcolor 3(setrgbcolor)prcmd currentdash mark 3 1 roll exch aload l"
"ength 1 add -1 roll counttomark(setdash)prcmd pop}if}def/setgstate{/setgstate "
"sysexec printgstate}def/save{@UD begin/@saveID vmstatus pop pop def end :save "
"@saveID 1(save)prcmd}def/restore{:restore printgstate @UD/@saveID known{@UD be"
"gin @saveID end}{0}ifelse 1(restore)prcmd}def/gsave 0 defpr/grestore{:grestore"
" printgstate 0(grestore)prcmd}def/grestoreall{:grestoreall setstate 0(grestore"
"all)prcmd}def/rotate{dup type/arraytype ne @dodraw and{dup 1(rotate)prcmd}if/r"
"otate sysexec applyscalevals}def/scale{dup type/arraytype ne @dodraw and{2 cop"
"y 2(scale)prcmd}if/scale sysexec applyscalevals}def/translate{dup type/arrayty"
"pe ne @dodraw and{2 copy 2(translate)prcmd}if/translate sysexec}def/setmatrix{"
"dup/setmatrix sysexec @dodraw{aload pop 6(setmatrix)prcmd applyscalevals}if}de"
"f/initmatrix{matrix setmatrix}def/concat{matrix currentmatrix matrix concatmat"
"rix setmatrix}def/makepattern{gsave<</mx 3 -1 roll>>begin dup/XUID[1000000 @pa"
"tcnt]put mx/makepattern sysexec dup dup begin PatternType @patcnt BBox aload p"
"op XStep YStep PaintType mx aload pop 15(makepattern)prcmd :newpath matrix set"
"matrix PaintProc 0 1(makepattern)prcmd end/@patcnt @patcnt 1 add store end gre"
"store}def/setpattern{begin PatternType 1 eq{PaintType 1 eq{XUID aload pop exch"
" pop 1}{:gsave[currentcolorspace aload length -1 roll pop]setcolorspace/setcol"
"or sysexec XUID aload pop exch pop currentrgbcolor :grestore 4}ifelse(setpatte"
"rn)prcmd}{/setpattern sysexec}ifelse end}def/setcolor{dup type/dicttype eq{set"
"pattern}{/setcolor sysexec/currentrgbcolor sysexec setrgbcolor}ifelse}def/setg"
"ray 1 defpr/setcmykcolor 4 defpr/sethsbcolor 3 defpr/setrgbcolor 3 defpr/.seto"
"pacityalpha{dup/.setopacityalpha sysexec 1(setopacityalpha)prcmd}def/.setshape"
"alpha{dup/.setshapealpha sysexec 1(setshapealpha)prcmd}def/.setblendmode{dup/."
"setblendmode sysexec<</Normal 0/Compatible 0/Multiply 1/Screen 2/Overlay 3/Sof"
"tLight 4/HardLight 5/ColorDodge 6/ColorBurn 7/Darken 8/Lighten 9/Difference 10"
"/Exclusion 11/Hue 12/Saturation 13/Color 14/Luminosity 15/CompatibleOverprint "
"16>>exch get 1(setblendmode)prcmd}def/@pdfpagecount{GS_PDF_ProcSet begin pdfdi"
"ct begin(r)file pdfopen begin pdfpagecount currentdict pdfclose end end end}de"
"f/@pdfpagebox{GS_PDF_ProcSet begin pdfdict begin(r)file pdfopen begin dup dup "
"1 lt exch pdfpagecount gt or{pop}{pdfgetpage/MediaBox pget pop aload pop}ifels"
"e currentdict pdfclose end end end}def DELAYBIND{.bindnow}if ";
