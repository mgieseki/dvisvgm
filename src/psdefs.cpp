...
"h 0(eoclip)prcmd}if}put @SD/shfill{begin currentdict/ShadingType known current"
"dict/ColorSpace known and currentdict/DataSource known and currentdict/Functio"
"n known not and ShadingType 4 ge{DataSource type/arraytype eq{<</DeviceGray 1/"
...
"d}if}if end}put @SD/image{dup type/dicttype eq{dup}{<</Width 6 index/Height 7 "
"index/colorimg false>>}ifelse @execimg}put @SD/colorimage{<<2 index{/Width 2 i"
"ndex 8 add index/Height 4 index 9 add index}{/Width 8 index/Height 9 index}ife"
"lse/colorimg true>>@execimg}put/@imgbase(./)def/@imgdevice(jpeg)def/@execimg{@"
"GD/@imgcnt 2 copy .knownget{1 add}{1}ifelse put begin<</imgdev null/imgid @GD/"
"@imgcnt get/ispng @imgdevice 0 3 getinterval(png)eq dup/suffix exch{(.png)}{(."
"jpg)}ifelse/colorimg currentdict/colorimg .knownget dup{pop}if/colordev 1 inde"
"x currentcolorspace dup length 1 ne exch 0 get/DeviceGray ne or or>>begin @img"
"device(png)ne @imgdevice(jpeg)ne and{@imgdevice cvn}{colordev{ispng{/png16m}{/"
"jpeg}ifelse}{ispng{/pnggray}{/jpeggray}ifelse}ifelse}ifelse dup devicedict exc"
"h known{:gsave/imgdev exch finddevice def mark/OutputFile @imgbase imgid 20 st"
"ring cvs strconcat suffix strconcat/PageSize[Width Height]/UseFastColor true i"
"spng{@imgdevice(pngmonod)eq{/MinFeatureSize where{pop/MinFeatureSize MinFeatur"
"eSize}if}if}{/JPEGQ where{pop/JPEGQ JPEGQ}if}ifelse imgdev putdeviceprops setd"
"evice[Width 0 0 Height neg 0 Height]/setmatrix sysexec colorimg{:colorimage}{:"
"image}ifelse/copypage sysexec mark/OutputFile()imgdev putdeviceprops pop :gres"
"tore imgid Width Height 3(image)prcmd}{pop colorimg{:colorimage}{:image}ifelse"
"}ifelse end end}def/@rect{4 -2 roll moveto exch dup 0 rlineto exch 0 exch rlin"
...
" length 4 idiv{@rectcc}repeat}{@rectcc}ifelse fill :grestore}put @SD/rectstrok"
"e{gsave :newpath dup type/arraytype eq{aload length 4 idiv{@rect}repeat}{@rect"
"}ifelse stroke grestore}put false setglobal @SD readonly pop/initclip 0 defpr/"
"clippath 0 defpr/sysexec{@SD exch get exec}def/adddot{dup length 1 add string "
"dup 0 46 put dup 3 -1 roll 1 exch putinterval}def/setlinewidth{dup/setlinewidt"
"h sysexec 1(setlinewidth)prcmd}def/setlinecap 1 defpr/setlinejoin 1 defpr/setm"
"iterlimit 1 defpr/setdash{mark 3 1 roll 2 copy/setdash sysexec exch aload leng"
"th 1 add -1 roll counttomark(setdash)prcmd pop}def/@setpagedevice{pop<<>>/setp"
"agedevice sysexec matrix setmatrix newpath 0(setpagedevice)prcmd}def/@checknul"
"ldev{@GD/@nulldev get{currentpagedevice maxlength 0 ne{@GD/@nulldev false put "
"0 1(setnulldevice)prcmd}if}if}def/prcolor{currentcolorspace @setcolorspace cur"
...
"1(setlinejoin)prcmd currentmiterlimit 1(setmiterlimit)prcmd prcolor currentdas"
"h mark 3 1 roll exch aload length 1 add -1 roll counttomark(setdash)prcmd pop}"
"if}def/strconcat{exch dup length 2 index length add string dup dup 4 2 roll co"
"py length 4 -1 roll putinterval}def/setgstate{/setgstate sysexec printgstate}d"
"ef/save{@UD begin/@saveID vmstatus pop pop def end :save @saveID 1(save)prcmd}"
"def/restore{:restore @checknulldev printgstate @UD/@saveID known{@UD begin @sa"
"veID end}{0}ifelse 1(restore)prcmd}def/gsave 0 defpr/grestore{:grestore @check"
"nulldev printgstate 0(grestore)prcmd}def/grestoreall{:grestoreall @checknullde"
"v setstate 0(grestoreall)prcmd}def/rotate{dup type/arraytype ne @dodraw and{du"
"p 1(rotate)prcmd}if/rotate sysexec applyscalevals}def/scale{dup type/arraytype"
" ne @dodraw and{2 copy 2(scale)prcmd}if/scale sysexec applyscalevals}def/trans"
"late{dup type/arraytype ne @dodraw and{2 copy 2(translate)prcmd}if/translate s"
"ysexec}def/setmatrix{dup/setmatrix sysexec @dodraw{aload pop 6(setmatrix)prcmd"
" applyscalevals}{pop}ifelse}def/initmatrix{matrix setmatrix}def/concat{matrix "
"currentmatrix matrix concatmatrix setmatrix}def/makepattern{gsave<</mx 3 -1 ro"
"ll>>begin<</XUID[1000000 @patcnt]>>copy mx/makepattern sysexec dup begin Patte"
"rnType 2 lt{PatternType @patcnt BBox aload pop XStep YStep PaintType mx aload "
"pop 15(makepattern)prcmd :newpath matrix setmatrix dup PaintProc 0 1(makepatte"
"rn)prcmd @GD/@patcnt @patcnt 1 add put}if end end grestore}def/setpattern{begi"
"n PatternType 1 eq{PaintType 1 eq{XUID aload pop exch pop 1}{:gsave[currentcol"
"orspace aload length -1 roll pop]/setcolorspace sysexec/setcolor sysexec XUID "
"aload pop exch pop currentrgbcolor :grestore 4}ifelse(setpattern)prcmd current"
"colorspace 0 get/Pattern ne{[/Pattern currentcolorspace]/setcolorspace sysexec"
"}if currentcolorspace @setcolorspace}{/setpattern sysexec}ifelse end}def/setco"
"lor{dup type/dicttype eq{setpattern}{/setcolor sysexec/currentrgbcolor sysexec"
" setrgbcolor}ifelse}def/setcolorspace{dup/setcolorspace sysexec @setcolorspace"
"}def/@setcolorspace{dup type/arraytype eq{0 get}if/Pattern eq{1}{0}ifelse 1(se"
"tcolorspace)prcmd}def/setgray 1 defpr/setcmykcolor 4 defpr/sethsbcolor 3 defpr"
