...
"how}put @SD/newpath{:newpath 0 1(newpath)prcmd}put @SD/stroke{@dodraw{prcolor "
"1 1(newpath)prcmd prpath 0(stroke)prcmd :newpath}{:stroke}ifelse}put @SD/fill{"
"@dodraw{prcolor 1 1(newpath)prcmd prpath 0(fill)prcmd :newpath}{:fill}ifelse}p"
"ut @SD/eofill{@dodraw{prcolor 1 1(newpath)prcmd prpath 0(eofill)prcmd :newpath"
"}{:eofill}ifelse}put @SD/clip{:clip 1 1(newpath)prcmd prpath 0(clip)prcmd}put "
"@SD/eoclip{:eoclip 1 1(newpath)prcmd prpath 0(eoclip)prcmd}put @SD/shfill{begi"
