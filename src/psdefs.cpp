...
"h 8 index/Height 9 index pstack}ifelse/colorimg true>>@execimg}put/@execimg{be"
"gin<</currdev currentdevice/pngdev null/imgid usertime abs/ctm matrix currentm"
"atrix/currcs currentcolorspace/colorimg currentdict/colorimg .knownget dup{pop"
"}if/colordev 1 index currentcolorspace dup length 1 ne exch 0 get/DeviceGray n"
"e or or>>begin/pngdev colordev{/png16m}{/pnggray}ifelse finddevice def mark/Ou"
"tputFile(test-)imgid 20 string cvs strconcat(.png)strconcat/PageSize[Width Hei"
"ght]/UseFastColor true pngdev putdeviceprops setdevice[Width 0 0 Height neg 0 "
"Height]/setmatrix sysexec colorimg{:colorimage}{:image}ifelse ctm/setmatrix sy"
"sexec/copypage sysexec currdev setdevice imgid Width Height 3(image)prcmd end "
"end}def/@rect{4 -2 roll moveto exch dup 0 rlineto exch 0 exch rlineto neg 0 rl"
"ineto closepath}bind def/@rectcc{4 -2 roll moveto 2 copy 0 lt exch 0 lt xor{du"
"p 0 exch rlineto exch 0 rlineto neg 0 exch rlineto}{exch dup 0 rlineto exch 0 "
"exch rlineto neg 0 rlineto}ifelse closepath}bind def @SD/rectclip{:newpath dup"
" type/arraytype eq{aload length 4 idiv{@rectcc}repeat}{@rectcc}ifelse clip :ne"
"wpath}put @SD/rectfill{gsave :newpath dup type/arraytype eq{aload length 4 idi"
"v{@rectcc}repeat}{@rectcc}ifelse fill grestore}put @SD/rectstroke{gsave :newpa"
...
"ice)prcmd}if}if}def/prcolor{currentrgbcolor 3(setrgbcolor)prcmd}def/printgstat"
"e{@dodraw @GD/@nulldev get not and{matrix currentmatrix aload pop 6(setmatrix)"
"prcmd applyscalevals currentlinewidth 1(setlinewidth)prcmd currentlinecap 1(se"
"tlinecap)prcmd currentlinejoin 1(setlinejoin)prcmd currentmiterlimit 1(setmite"
"rlimit)prcmd currentrgbcolor 3(setrgbcolor)prcmd currentdash mark 3 1 roll exc"
"h aload length 1 add -1 roll counttomark(setdash)prcmd pop}if}def/strconcat{ex"
"ch dup length 2 index length add string dup dup 4 2 roll copy length 4 -1 roll"
" putinterval}def/setgstate{/setgstate sysexec printgstate}def/save{@UD begin/@"
"saveID vmstatus pop pop def end :save @saveID 1(save)prcmd}def/restore{:restor"
"e @checknulldev printgstate @UD/@saveID known{@UD begin @saveID end}{0}ifelse "
"1(restore)prcmd}def/gsave 0 defpr/grestore{:grestore @checknulldev printgstate"
" 0(grestore)prcmd}def/grestoreall{:grestoreall @checknulldev setstate 0(gresto"
...
"x{dup/setmatrix sysexec @dodraw{aload pop 6(setmatrix)prcmd applyscalevals}{po"
"p}ifelse}def/initmatrix{matrix setmatrix}def/concat{matrix currentmatrix matri"
"x concatmatrix setmatrix}def/makepattern{gsave<</mx 3 -1 roll>>begin dup/XUID["
"1000000 @patcnt]put mx/makepattern sysexec dup dup begin PatternType @patcnt B"
"Box aload pop XStep YStep PaintType mx aload pop 15(makepattern)prcmd :newpath"
" matrix setmatrix PaintProc 0 1(makepattern)prcmd end/@patcnt @patcnt 1 add st"
"ore end grestore}def/setpattern{begin PatternType 1 eq{PaintType 1 eq{XUID alo"
"ad pop exch pop 1}{:gsave[currentcolorspace aload length -1 roll pop]setcolors"
"pace/setcolor sysexec XUID aload pop exch pop currentrgbcolor :grestore 4}ifel"
"se(setpattern)prcmd}{/setpattern sysexec}ifelse end}def/setcolor{dup type/dict"
"type eq{setpattern}{/setcolor sysexec/currentrgbcolor sysexec setrgbcolor}ifel"
"se}def/setgray 1 defpr/setcmykcolor 4 defpr/sethsbcolor 3 defpr/setrgbcolor 3 "
"defpr/.setopacityalpha{dup/.setopacityalpha sysexec 1(setopacityalpha)prcmd}de"
"f/.setshapealpha{dup/.setshapealpha sysexec 1(setshapealpha)prcmd}def/.setblen"
"dmode{dup/.setblendmode sysexec<</Normal 0/Compatible 0/Multiply 1/Screen 2/Ov"
"erlay 3/SoftLight 4/HardLight 5/ColorDodge 6/ColorBurn 7/Darken 8/Lighten 9/Di"
"fference 10/Exclusion 11/Hue 12/Saturation 13/Color 14/Luminosity 15/Compatibl"
"eOverprint 16>>exch get 1(setblendmode)prcmd}def/@pdfpagecount{(r)file runpdfb"
"egin pdfpagecount runpdfend}def/@pdfpagebox{(r)file runpdfbegin dup dup 1 lt e"
"xch pdfpagecount gt or{pop}{pdfgetpage/MediaBox pget pop aload pop}ifelse runp"
"dfend}def DELAYBIND{.bindnow}if ";
