...
"a .currentshapealpha .setshapealpha}{.currentalphaisshape{1}{0}ifelse 1(setiss"
"hapealpha)prcmd .currentstrokeconstantalpha 1(setstrokeconstantalpha)prcmd .cu"
...
"talphaisshape sysexec}if{1}{0}ifelse 1(setisshapealpha)prcmd}bind def/.setfill"
