...
"ndex/Height 9 index}ifelse/colorimg true>>@execimg}put/@execimg{@GD/@imgcnt 2 "
"copy .knownget{1 add}{1}ifelse put begin<</pngdev null/imgid @GD/@imgcnt get/c"
"olorimg currentdict/colorimg .knownget dup{pop}if/colordev 1 index currentcolo"
"rspace dup length 1 ne exch 0 get/DeviceGray ne or or>>begin colordev{/png16m}"
"{/pnggray}ifelse dup devicedict exch known{:gsave/pngdev exch finddevice def m"
"ark/OutputFile @imgbase imgid 20 string cvs strconcat(.png)strconcat/PageSize["
"Width Height]/UseFastColor true pngdev putdeviceprops setdevice[Width 0 0 Heig"
"ht neg 0 Height]/setmatrix sysexec colorimg{:colorimage}{:image}ifelse/copypag"
"e sysexec mark/OutputFile()pngdev putdeviceprops pop :grestore imgid Width Hei"
"ght 3(image)prcmd}{-1 0 0 3(image)prcmd}ifelse end end}def/@rect{4 -2 roll mov"
"eto exch dup 0 rlineto exch 0 exch rlineto neg 0 rlineto closepath}bind def/@r"
"ectcc{4 -2 roll moveto 2 copy 0 lt exch 0 lt xor{dup 0 exch rlineto exch 0 rli"
"neto neg 0 exch rlineto}{exch dup 0 rlineto exch 0 exch rlineto neg 0 rlineto}"
"ifelse closepath}bind def @SD/rectclip{:newpath dup type/arraytype eq{aload le"
"ngth 4 idiv{@rectcc}repeat}{@rectcc}ifelse clip :newpath}put @SD/rectfill{gsav"
"e :newpath dup type/arraytype eq{aload length 4 idiv{@rectcc}repeat}{@rectcc}i"
"felse fill grestore}put @SD/rectstroke{gsave :newpath dup type/arraytype eq{al"
"oad length 4 idiv{@rect}repeat}{@rect}ifelse stroke grestore}put false setglob"
"al @SD readonly pop/initclip 0 defpr/clippath 0 defpr/sysexec{@SD exch get exe"
"c}def/adddot{dup length 1 add string dup 0 46 put dup 3 -1 roll 1 exch putinte"
"rval}def/setlinewidth{dup/setlinewidth sysexec 1(setlinewidth)prcmd}def/setlin"
"ecap 1 defpr/setlinejoin 1 defpr/setmiterlimit 1 defpr/setdash{mark 3 1 roll 2"
" copy/setdash sysexec exch aload length 1 add -1 roll counttomark(setdash)prcm"
"d pop}def/@setpagedevice{pop<<>>/setpagedevice sysexec matrix setmatrix newpat"
"h 0(setpagedevice)prcmd}def/@checknulldev{@GD/@nulldev get{currentpagedevice m"
"axlength 0 ne{@GD/@nulldev false put 0 1(setnulldevice)prcmd}if}if}def/prcolor"
"{currentrgbcolor 3(setrgbcolor)prcmd}def/printgstate{@dodraw @GD/@nulldev get "
"not and{matrix currentmatrix aload pop 6(setmatrix)prcmd applyscalevals curren"
"tlinewidth 1(setlinewidth)prcmd currentlinecap 1(setlinecap)prcmd currentlinej"
"oin 1(setlinejoin)prcmd currentmiterlimit 1(setmiterlimit)prcmd currentrgbcolo"
"r 3(setrgbcolor)prcmd currentdash mark 3 1 roll exch aload length 1 add -1 rol"
"l counttomark(setdash)prcmd pop}if}def/strconcat{exch dup length 2 index lengt"
"h add string dup dup 4 2 roll copy length 4 -1 roll putinterval}def/setgstate{"
"/setgstate sysexec printgstate}def/save{@UD begin/@saveID vmstatus pop pop def"
" end :save @saveID 1(save)prcmd}def/restore{:restore @checknulldev printgstate"
" @UD/@saveID known{@UD begin @saveID end}{0}ifelse 1(restore)prcmd}def/gsave 0"
" defpr/grestore{:grestore @checknulldev printgstate 0(grestore)prcmd}def/grest"
"oreall{:grestoreall @checknulldev setstate 0(grestoreall)prcmd}def/rotate{dup "
"type/arraytype ne @dodraw and{dup 1(rotate)prcmd}if/rotate sysexec applyscalev"
"als}def/scale{dup type/arraytype ne @dodraw and{2 copy 2(scale)prcmd}if/scale "
"sysexec applyscalevals}def/translate{dup type/arraytype ne @dodraw and{2 copy "
"2(translate)prcmd}if/translate sysexec}def/setmatrix{dup/setmatrix sysexec @do"
"draw{aload pop 6(setmatrix)prcmd applyscalevals}{pop}ifelse}def/initmatrix{mat"
