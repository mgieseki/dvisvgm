...
"D/@imgcnt 2 copy .knownget{1 add}{1}ifelse put begin<</maindev currentdevice/p"
...
"img{:colorimage}{:image}ifelse ctm/setmatrix sysexec mark/OutputFile()pngdev p"
"utdeviceprops pop maindev setdevice imgid Width Height 3(image)prcmd end end}d"
"ef/@rect{4 -2 roll moveto exch dup 0 rlineto exch 0 exch rlineto neg 0 rlineto"
" closepath}bind def/@rectcc{4 -2 roll moveto 2 copy 0 lt exch 0 lt xor{dup 0 e"
"xch rlineto exch 0 rlineto neg 0 exch rlineto}{exch dup 0 rlineto exch 0 exch "
"rlineto neg 0 rlineto}ifelse closepath}bind def @SD/rectclip{:newpath dup type"
"/arraytype eq{aload length 4 idiv{@rectcc}repeat}{@rectcc}ifelse clip :newpath"
"}put @SD/rectfill{gsave :newpath dup type/arraytype eq{aload length 4 idiv{@re"
"ctcc}repeat}{@rectcc}ifelse fill grestore}put @SD/rectstroke{gsave :newpath du"
"p type/arraytype eq{aload length 4 idiv{@rect}repeat}{@rect}ifelse stroke gres"
"tore}put false setglobal @SD readonly pop/initclip 0 defpr/clippath 0 defpr/sy"
"sexec{@SD exch get exec}def/adddot{dup length 1 add string dup 0 46 put dup 3 "
"-1 roll 1 exch putinterval}def/setlinewidth{dup/setlinewidth sysexec 1(setline"
"width)prcmd}def/setlinecap 1 defpr/setlinejoin 1 defpr/setmiterlimit 1 defpr/s"
"etdash{mark 3 1 roll 2 copy/setdash sysexec exch aload length 1 add -1 roll co"
"unttomark(setdash)prcmd pop}def/@setpagedevice{pop<<>>/setpagedevice sysexec m"
...
"rcmd}if}if}def/prcolor{currentrgbcolor 3(setrgbcolor)prcmd}def/printgstate{@do"
"draw @GD/@nulldev get not and{matrix currentmatrix aload pop 6(setmatrix)prcmd"
" applyscalevals currentlinewidth 1(setlinewidth)prcmd currentlinecap 1(setline"
"cap)prcmd currentlinejoin 1(setlinejoin)prcmd currentmiterlimit 1(setmiterlimi"
"t)prcmd currentrgbcolor 3(setrgbcolor)prcmd currentdash mark 3 1 roll exch alo"
"ad length 1 add -1 roll counttomark(setdash)prcmd pop}if}def/strconcat{exch du"
"p length 2 index length add string dup dup 4 2 roll copy length 4 -1 roll puti"
"nterval}def/setgstate{/setgstate sysexec printgstate}def/save{@UD begin/@saveI"
"D vmstatus pop pop def end :save @saveID 1(save)prcmd}def/restore{:restore @ch"
"ecknulldev printgstate @UD/@saveID known{@UD begin @saveID end}{0}ifelse 1(res"
"tore)prcmd}def/gsave 0 defpr/grestore{:grestore @checknulldev printgstate 0(gr"
"estore)prcmd}def/grestoreall{:grestoreall @checknulldev setstate 0(grestoreall"
")prcmd}def/rotate{dup type/arraytype ne @dodraw and{dup 1(rotate)prcmd}if/rota"
"te sysexec applyscalevals}def/scale{dup type/arraytype ne @dodraw and{2 copy 2"
"(scale)prcmd}if/scale sysexec applyscalevals}def/translate{dup type/arraytype "
"ne @dodraw and{2 copy 2(translate)prcmd}if/translate sysexec}def/setmatrix{dup"
"/setmatrix sysexec @dodraw{aload pop 6(setmatrix)prcmd applyscalevals}{pop}ife"
"lse}def/initmatrix{matrix setmatrix}def/concat{matrix currentmatrix matrix con"
"catmatrix setmatrix}def/makepattern{gsave<</mx 3 -1 roll>>begin dup/XUID[10000"
"00 @patcnt]put mx/makepattern sysexec dup dup begin PatternType @patcnt BBox a"
"load pop XStep YStep PaintType mx aload pop 15(makepattern)prcmd :newpath matr"
"ix setmatrix PaintProc 0 1(makepattern)prcmd end/@patcnt @patcnt 1 add store e"
"nd grestore}def/setpattern{begin PatternType 1 eq{PaintType 1 eq{XUID aload po"
"p exch pop 1}{:gsave[currentcolorspace aload length -1 roll pop]setcolorspace/"
"setcolor sysexec XUID aload pop exch pop currentrgbcolor :grestore 4}ifelse(se"
"tpattern)prcmd}{/setpattern sysexec}ifelse end}def/setcolor{dup type/dicttype "
"eq{setpattern}{/setcolor sysexec/currentrgbcolor sysexec setrgbcolor}ifelse}de"
"f/setgray 1 defpr/setcmykcolor 4 defpr/sethsbcolor 3 defpr/setrgbcolor 3 defpr"
"/.setopacityalpha{dup/.setopacityalpha sysexec 1(setopacityalpha)prcmd}def/.se"
"tshapealpha{dup/.setshapealpha sysexec 1(setshapealpha)prcmd}def/.setblendmode"
"{dup/.setblendmode sysexec<</Normal 0/Compatible 0/Multiply 1/Screen 2/Overlay"
" 3/SoftLight 4/HardLight 5/ColorDodge 6/ColorBurn 7/Darken 8/Lighten 9/Differe"
"nce 10/Exclusion 11/Hue 12/Saturation 13/Color 14/Luminosity 15/CompatibleOver"
"print 16>>exch get 1(setblendmode)prcmd}def/@pdfpagecount{(r)file runpdfbegin "
"pdfpagecount runpdfend}def/@pdfpagebox{(r)file runpdfbegin dup dup 1 lt exch p"
"dfpagecount gt or{pop}{pdfgetpage/MediaBox pget pop aload pop}ifelse runpdfend"
