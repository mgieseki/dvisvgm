...
"nt 2 copy .knownget{1 add}{1}ifelse put begin<</maindev currentdevice/pngdev n"
"ull/imgid @imgcnt/ctm matrix currentmatrix/currcs currentcolorspace/colorimg c"
"urrentdict/colorimg .knownget dup{pop}if/colordev 1 index currentcolorspace du"
"p length 1 ne exch 0 get/DeviceGray ne or or>>begin colordev{/png16m}{/pnggray"
"}ifelse dup devicedict exch known{/pngdev exch finddevice def mark/OutputFile "
"@imgbase imgid 20 string cvs strconcat(.png)strconcat/PageSize[Width Height]/U"
"seFastColor true pngdev putdeviceprops setdevice[Width 0 0 Height neg 0 Height"
"]/setmatrix sysexec colorimg{:colorimage}{:image}ifelse ctm/setmatrix sysexec/"
"copypage sysexec mark/OutputFile()pngdev putdeviceprops pop maindev setdevice "
"imgid Width Height 3(image)prcmd}{-1 0 0 3(image)prcmd}ifelse end end}def/@rec"
"t{4 -2 roll moveto exch dup 0 rlineto exch 0 exch rlineto neg 0 rlineto closep"
"ath}bind def/@rectcc{4 -2 roll moveto 2 copy 0 lt exch 0 lt xor{dup 0 exch rli"
"neto exch 0 rlineto neg 0 exch rlineto}{exch dup 0 rlineto exch 0 exch rlineto"
" neg 0 rlineto}ifelse closepath}bind def @SD/rectclip{:newpath dup type/arrayt"
"ype eq{aload length 4 idiv{@rectcc}repeat}{@rectcc}ifelse clip :newpath}put @S"
"D/rectfill{gsave :newpath dup type/arraytype eq{aload length 4 idiv{@rectcc}re"
"peat}{@rectcc}ifelse fill grestore}put @SD/rectstroke{gsave :newpath dup type/"
"arraytype eq{aload length 4 idiv{@rect}repeat}{@rect}ifelse stroke grestore}pu"
"t false setglobal @SD readonly pop/initclip 0 defpr/clippath 0 defpr/sysexec{@"
"SD exch get exec}def/adddot{dup length 1 add string dup 0 46 put dup 3 -1 roll"
" 1 exch putinterval}def/setlinewidth{dup/setlinewidth sysexec 1(setlinewidth)p"
"rcmd}def/setlinecap 1 defpr/setlinejoin 1 defpr/setmiterlimit 1 defpr/setdash{"
"mark 3 1 roll 2 copy/setdash sysexec exch aload length 1 add -1 roll counttoma"
"rk(setdash)prcmd pop}def/@setpagedevice{pop<<>>/setpagedevice sysexec matrix s"
"etmatrix newpath 0(setpagedevice)prcmd}def/@checknulldev{@GD/@nulldev get{curr"
"entpagedevice maxlength 0 ne{@GD/@nulldev false put 0 1(setnulldevice)prcmd}if"
"}if}def/prcolor{currentrgbcolor 3(setrgbcolor)prcmd}def/printgstate{@dodraw @G"
"D/@nulldev get not and{matrix currentmatrix aload pop 6(setmatrix)prcmd applys"
"calevals currentlinewidth 1(setlinewidth)prcmd currentlinecap 1(setlinecap)prc"
"md currentlinejoin 1(setlinejoin)prcmd currentmiterlimit 1(setmiterlimit)prcmd"
" currentrgbcolor 3(setrgbcolor)prcmd currentdash mark 3 1 roll exch aload leng"
"th 1 add -1 roll counttomark(setdash)prcmd pop}if}def/strconcat{exch dup lengt"
"h 2 index length add string dup dup 4 2 roll copy length 4 -1 roll putinterval"
"}def/setgstate{/setgstate sysexec printgstate}def/save{@UD begin/@saveID vmsta"
"tus pop pop def end :save @saveID 1(save)prcmd}def/restore{:restore @checknull"
"dev printgstate @UD/@saveID known{@UD begin @saveID end}{0}ifelse 1(restore)pr"
"cmd}def/gsave 0 defpr/grestore{:grestore @checknulldev printgstate 0(grestore)"
"prcmd}def/grestoreall{:grestoreall @checknulldev setstate 0(grestoreall)prcmd}"
"def/rotate{dup type/arraytype ne @dodraw and{dup 1(rotate)prcmd}if/rotate syse"
"xec applyscalevals}def/scale{dup type/arraytype ne @dodraw and{2 copy 2(scale)"
"prcmd}if/scale sysexec applyscalevals}def/translate{dup type/arraytype ne @dod"
"raw and{2 copy 2(translate)prcmd}if/translate sysexec}def/setmatrix{dup/setmat"
"rix sysexec @dodraw{aload pop 6(setmatrix)prcmd applyscalevals}{pop}ifelse}def"
...
"6>>exch get 1(setblendmode)prcmd}def/@pdfpagecount{(r)file runpdfbegin pdfpage"
"count runpdfend}def/@pdfpagebox{(r)file runpdfbegin dup dup 1 lt exch pdfpagec"
"ount gt or{pop}{pdfgetpage/MediaBox pget pop aload pop}ifelse runpdfend}def DE"
"LAYBIND{.bindnow}if ";
