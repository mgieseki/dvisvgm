...
" 0 -1 0 0]setmatrix newpath 0(setpagedevice)prcmd}def/setgstate{currentlinewid"
...
"gbcolor)prcmd matrix currentmatrix aload pop 6(setmatrix)prcmd applyscalevals "
"currentdash mark 3 1 roll exch aload length 1 add -1 roll counttomark(setdash)"
"prcmd pop}def/save{@UD begin/@saveID vmstatus pop pop def end :save @saveID 1("
"save)prcmd}def/restore{:restore setgstate @UD/@saveID known{@UD begin @saveID "
"end}{0}ifelse 1(restore)prcmd}def/gsave 0 defpr/grestore{:grestore setgstate 0"
"(grestore)prcmd}def/grestoreall{:grestoreall setstate 0(grestoreall)prcmd}def/"
"rotate{dup type/arraytype ne{dup 1(rotate)prcmd}if/rotate sysexec applyscaleva"
"ls}def/scale{dup type/arraytype ne{2 copy 2(scale)prcmd}if/scale sysexec apply"
"scalevals}def/translate{dup type/arraytype ne{2 copy 2(translate)prcmd}if/tran"
"slate sysexec}def/setmatrix{dup/setmatrix sysexec aload pop 6(setmatrix)prcmd "
"applyscalevals}def/initmatrix{matrix setmatrix}def/concat{matrix currentmatrix"
" matrix concatmatrix setmatrix}def/makepattern{gsave<</mx 3 -1 roll>>begin dup"
"/XUID[1000000 @patcnt]put mx/makepattern sysexec dup dup begin PatternType @pa"
"tcnt BBox aload pop XStep YStep PaintType mx aload pop 15(makepattern)prcmd :n"
"ewpath matrix setmatrix PaintProc 0 1(makepattern)prcmd end/@patcnt @patcnt 1 "
"add store end grestore}def/setpattern{begin PatternType 1 eq{PaintType 1 eq{XU"
"ID aload pop exch pop 1}{:gsave[currentcolorspace aload length -1 roll pop]set"
"colorspace/setcolor sysexec XUID aload pop exch pop currentrgbcolor :grestore "
"4}ifelse(setpattern)prcmd}{/setpattern sysexec}ifelse end}def/setcolor{dup typ"
"e/dicttype eq{setpattern}{/setcolor sysexec/currentrgbcolor sysexec setrgbcolo"
"r}ifelse}def/setgray 1 defpr/setcmykcolor 4 defpr/sethsbcolor 3 defpr/setrgbco"
"lor 3 defpr/.setopacityalpha{dup/.setopacityalpha sysexec 1(setopacityalpha)pr"
"cmd}def/.setshapealpha{dup/.setshapealpha sysexec 1(setshapealpha)prcmd}def/.s"
"etblendmode{dup/.setblendmode sysexec<</Normal 0/Compatible 0/Multiply 1/Scree"
"n 2/Overlay 3/SoftLight 4/HardLight 5/ColorDodge 6/ColorBurn 7/Darken 8/Lighte"
"n 9/Difference 10/Exclusion 11/Hue 12/Saturation 13/Color 14/Luminosity 15/Com"
"patibleOverprint 16>>exch get 1(setblendmode)prcmd}def ";
